...
extern "C"
{
  ...
  **********************************************************/
  ...
  typedef unsigned char uint8; /* defined for unsigned 8-bits integer variable
                                  无符号8位整型变量  */
  typedef signed char
      int8; /* defined for signed 8-bits integer variable 有符号8位整型变量  */
...
#define ZAUX_COMMAND_SUM 100  // 写命令数，调试时使用
  ...
  *************************************************************/
  int32 ZAux_SearchEthlist(char *ipaddrlist, uint32 addrbufflength,
                           uint32 uims);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_GetModbusDpos(ZMC_HANDLE handle, int imaxaxises,
                           float *pValueList);
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_GetModbusMpos(ZMC_HANDLE handle, int imaxaxises,
                           float *pValueList);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_GetMovesBuffered(ZMC_HANDLE handle, int iaxis,
                                     int *piValue);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_GetRemain_Buffer(ZMC_HANDLE handle, int iaxis,
                                     int *piValue);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveAbsSp(ZMC_HANDLE handle, int imaxaxises,
  ...
  *************************************************************/
  ...
  /*************************************************************
  Description:    //相对圆心定圆弧插补运动 插补SP运动  20130901
  以后的控制器版本支持 Input:          //卡链接handle imaxaxises
  参与运动总轴数 piAxislist			轴号列表 end1 第一个轴运动坐标
                  end2              第二个轴运动坐标
                  centre1    第一个轴运动圆心，相对与起始点。
                  centre2    第二个轴运动圆心，相对与起始点。
                  direction  0-逆时针，1-顺时针
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveCirc2(ZMC_HANDLE handle, int imaxaxises,
  ...
  *************************************************************/
  ...
  Input:          //卡链接handle
                  ...
                  distance3第三个轴运动距离。
                  mode      第三轴的速度计算:0(缺省)
  第三轴参与速度计算。1第三轴不参与速度计算。 Output:         // Return:
  //错误码
  *************************************************************/
  ...
  Input:          //卡链接handle
                  ...
                  direction  0-逆时针，1-顺时针
                  distance3第三个轴运动距离。
                mode      第三轴的速度计算: 0(缺省)第三轴参与速度计算。
  1第三轴不参与速度计算。 Output:         // Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MHelicalSp(ZMC_HANDLE handle, int imaxaxises,
                               int *piAxislist, float fend1, float fend2,
                               float fcenter1, float fcenter2, int idirection,
                               float fDistance3, int imode);
  ...
  *************************************************************/
  int32 ZAux_Direct_MHelicalAbsSp(ZMC_HANDLE handle, int imaxaxises,
                                  int *piAxislist, float fend1, float fend2,
                                  float fcenter1, float fcenter2,
                                  int idirection, float fDistance3, int imode);
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MHelical2(ZMC_HANDLE handle, int imaxaxises,
                              int *piAxislist, float fmid1, float fmid2,
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MEclipseSp(ZMC_HANDLE handle, int imaxaxises,
                               int *piAxislist, float fend1, float fend2,
                               float fcenter1, float fcenter2, int idirection,
                               float fADis, float fBDis);
  ...
  *************************************************************/
  ...
  Input:          //卡链接handle
                  ...
                  mode      指定前面参数的意义
                      0
  当前点，中间点，终点三点定圆弧，距离参数1为终点距离，距离参数2为中间点距离。
                      1
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MSpherical(ZMC_HANDLE handle, int imaxaxises,
                               int *piAxislist, float fend1, float fend2,
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveSpiral(ZMC_HANDLE handle, int imaxaxises,
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveSmooth(ZMC_HANDLE handle, int imaxaxises,
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveOp2(ZMC_HANDLE handle, int iaxis, int ioutnum,
                            int ivalue, int iofftimems);
  ...
  *************************************************************/
  int32 ZAux_Direct_McircTurnabs(ZMC_HANDLE handle, int tablenum, float refpos1,
                                 float refpos2, int mode, float end1,
                                 float end2, int imaxaxises, int *piAxislist,
                                 float *pfDisancelist);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MovePara(ZMC_HANDLE handle, uint32 base_axis,
                             char *paraname, uint32 iaxis, float fvalue);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveSynmove(ZMC_HANDLE handle, uint32 base_axis,
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveWait(ZMC_HANDLE handle, uint32 base_axis,
                             char *paraname, int inum, int Cmp_mode,
                             float fvalue);
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MoveTask(ZMC_HANDLE handle, uint32 base_axis,
                             uint32 tasknum, char *labelname);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_GetUserVar(ZMC_HANDLE handle, char *varname,
                               float *pfValue);
  ...
  *************************************************************/
  ...
  Return:         //错误码
  uint32  ZMC_GetSoftVersion(ZMC_HANDLE handle,float *pVersion, char
  *pVerString, uint32 *pVerDate);
  *************************************************************/
  ...
  *************************************************************/
  ...
  Input:          //卡链接handle
                  slot	槽位号
                  node	节点编号
                  sel		信息编号	0-厂商编号1-设备编号 2-设备版本
  3-别名 10-IN个数 11-OUT个数 Output:         //piValue 返回信息 Return:
  //错误码
  *************************************************************/
  ...
  *************************************************************/
  ...
  Input:          //卡链接handle
                  ...
                  type	数据类型  1-bool 2-int8 3-int16 4-int32 5-uint8 6-uint16
  7-uint32 Output:         //value 读取的数据值 Return:         //错误码
  *************************************************************/
  ...
  Input:          //卡链接handle
                  ...
                  subindex	子编号	（注意函数为10进制数据）
                  type	数据类型  1-bool 2-int8 3-int16 4-int32 5-uint8 6-uint16
  7-uint32 value	设定的数据值 Return:         //错误码
  *************************************************************/
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_BusCmd_SetMaxDriveTorque(ZMC_HANDLE handle, int iaxis,
                                      int piValue);
  ...
  *************************************************************/
  ...
  /*************************************************************
  Description:    //总线初始化  （针对Zmotion tools
  ...
  *************************************************************/
  ...
  /*************************************************************
  Description:    //获取总线初始化完成状态  （针对Zmotion tools
  工具软件配置过总线参数控制器使用有效） Input:          //卡链接handle Output:
  ...
  *************************************************************/
  ...
  Return:         //错误码
  *************************************************************/
  int32 ZAux_Direct_MultiMoveAbs(ZMC_HANDLE handle, int iMoveLen,
  ...
  *************************************************************/
  int32 ZAux_GetCanInfo(ZMC_HANDLE handle, uint8 *CanNum, uint16 *CanId_List,
                        uint8 *CanIn_List, uint8 *CanOut_List,
                        uint8 *CanAin_List, uint8 *CanAOut_List,
                        uint8 *CanAxis_List);
